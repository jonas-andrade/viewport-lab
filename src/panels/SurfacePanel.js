...
export class SurfacePanel {
    constructor(folder, { mesh }) {
        ...
        this.state = {
            ...
            color: { r: 0.31, g: 0.56, b: 0.97 }, // #4f8ef7 em float
            roughness: 0.4,
            metalness: 0.1,
    ...
    _build() {
        ...
        f.addBinding(this.state, 'color', {
            ...
            if (this.mesh.material.color) {
                // type: 'float' já entrega valores 0-1 — sem divisão por 255
    ...
    _buildPBR(f) {
        ...
        f.addBinding(this.state, 'emissive', {
            ...
            if (this.mesh.material.emissive) {
                // type: 'float' — sem divisão por 255
    ...
    _swapMaterial(typeName) {
        ...
        const props = {
            // state.color já está em float 0-1 — passa direto
